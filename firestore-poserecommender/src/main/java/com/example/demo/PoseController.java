...
private static final String param_url = "projects/civic-indexer-452914-c8/databases/(default)/documents/poses/";
String project = "civic-indexer-452914-c8";
String location = "us-central1";
private static final String queryString = "{\"structuredQuery\":{\"select\":{\"fields\":[{\"fieldPath\":\"name\"}]},\"from\":[{\"collectionId\":\"poses\"}]}}";
private static final String runQuery = "projects/civic-indexer-452914-c8/databases/(default)/documents:runQuery";
...
public String callPoseByIdContext(Pose pose){
    ...
    FirestoreOptions.getDefaultInstance().toBuilder()
        .setProjectId("civic-indexer-452914-c8")
...
public String callGemini(Pose pose) {
   ...
   try{
    ...
    String apiUrl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-exp:generateContent?key=AIzaSyA0gbao4QENUjzqZ3zKlqmm7YtIPw8FS_4";
